...
int main()
{
    ...
    do
    {
        ...
        case 4:
            ...
            printf("\n1. Empleados ordenados alfabeticamente (Sector y salary). \n\n2. Mostrar suma y promedio de salarys, y cuantos empleados superan el salary  minimo ($15000).\n\nElija opcion: ");
            scanf("%d", &subMenu);
            ...
            case 1:
                ...
                sortEmployees(listadoEmpleados, T); /*ORDENA A LOS EMPLEADOS*/
